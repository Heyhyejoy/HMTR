...
const CarComponent = ({ modelName, modelImageUrl, detailsUrl }) => {
    ...
    return (
        <div className='ml-8'>
            <div 
            className='flex flex-column align-items-center pt-6 surface-section border-0 hover:border-blue-900 border-2 border-round-xl text-surface-100 font-bold m-2 flex align-items-center justify-content-center" w-19rem h-16rem'>
